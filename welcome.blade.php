...
<body>
    ...
    <header id="header" class="fixed-top ">
        <div class="container d-flex align-items-center">
            ...
            <h1 class="logo me-auto"><a href="#">SPK-SAW</a></h1>
...
<!-- End About Us Section -->
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    <div class="col-lg-6 d-flex align-items-center" data-aos="fade-right" data-aos-delay="100">
                        <img src="{{ asset('Arsha/assets/img/nurul2.jpg') }}" class="img-fluid" alt="">
                    </div>
                    <div class="col-lg-6 pt-4 pt-lg-0 content" data-aos="fade-left" data-aos-delay="100">
                        <h3>Tentang Saya</h3>
                        <p class="fst-italic">
                            Nurul Aisyah - PHB TEGAL
                        </p>
    ...
    <footer id="footer">
        ...
        <div class="container text-center footer-bottom clearfix">
            <div class="copyright">
                &copy; Copyright <strong><span>nurul aisyah </span></strong>. All Rights Reserved 2023
            </div>
        </div>
    </footer><!-- End Footer -->
